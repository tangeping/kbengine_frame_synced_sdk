...
namespace KBEngine
{
    ...
    public class AStarPathfinder
    {
        ...
        public readonly Grid gridMap = null;
        ...
        Node AllocateNode()
        {
            ...
            {
                throw new IndexOutOfRangeException("FATAL - Pathfinder ran out of preallocated nodes!");
            }

            return m_FixedSizeAllocator[m_AllocateNodeCount++];
        }

        public MapSearchNode AllocateMapSearchNode(Vector2Int nodeIndex)
        {
            ...
            mapSearchNodePool[allocatedMapSearchNodes].nodeIndex = nodeIndex;
